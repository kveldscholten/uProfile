...
$script_name = 'uProfil';    // Name des Moduls
$script_vers = '1.7';        // Version des Moduls
...
if (!isset($_POST['do'])) {
    ...
    ?>
    <form action="index.php?uprofil_install" method="POST">
    ...
    $error = '';
    $sql_file = implode('', file('include/contents/uprofil_install.sql'));
        ...
        <tr class="Cmite">
            <td colspan="3" align="center">
                ...
                if (!empty($error)) {
                    ...
                    if (@unlink('include/contents/uprofil_install.php') && @unlink('include/contents/uprofil_install.sql')) {
                        $erfolg .= '<br /><br />Diese Installationsdateien wurden erfolgreich gel&ouml;scht. Es muss nichts mehr getan werden.';
                    } else {
                        $erfolg .= '<br /><br /><strong>Die Installationsdateien konnten nicht automatisch gel&ouml;scht werden. L&ouml;schen Sie folgende Dateien:</strong><br /><br /><i>include/contents/uprofil_install.php</i><br /><i>include/contents/uprofil_install.sql</i>';
                    }
